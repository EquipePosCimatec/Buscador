...
def main():
    ...
    try:
        ...
        st.error(f"Erro ao carregar o Diário Oficial: A data informada não teve publicação de Diário Oficial. Se o dia: {data_usuario} for a data de hoje e for dia útil, possivelmente o Diário Oficial ainda não foi disponibilizado no servidor do MPBA, neste caso, tente novamente mais tarde.")
        return
